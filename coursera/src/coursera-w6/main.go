...
var (
	...
	// docker run -p 3320:3306 -v $(PWD):/docker-entrypoint-initdb.d -e MYSQL_ROOT_PASSWORD=1234 -e MYSQL_USER=alex -e MYSQL_PASSWORD=123456 -e MYSQL_DATABASE=golang -d mysql
	DSN = "alex:123456@tcp(localhost:3320)/golang?charset=utf8"
